    ...
    <div className="flex flex-col min-h-screen relative z-1">
      ...
      <main className="flex-1 p-6 max-w-[1100px] mx-auto w-full">
        ...
        >
            ...
            <div className="mb-4">
              ...
              <div className={wrap}>
                <input type="number" min="0.5" max="24" step="0.5"
                  placeholder={form.durationText ? `~${form.estimatedDuration}` : "e.g. 3"}
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 bg-primary text-bg rounded-full text-[0.95rem] font-bold cursor-pointer flex items-center justify-center gap-2 transition-all hover:opacity-90 hover:-translate-y-px border-none">
            Register Hike
